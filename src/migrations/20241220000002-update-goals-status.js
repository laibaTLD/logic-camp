...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.sequelize.transaction(async (t) => {
      ...
      await queryInterface.addColumn('goals', 'status_id', {
      ...
      await queryInterface.changeColumn('goals', 'status_id', {
        type: Sequelize.INTEGER,
        allowNull: false,
        references: {
          model: 'statuses',
      ...
      await queryInterface.removeColumn('goals', 'status', { transaction: t });
    });
  },
  ...
  down: async (queryInterface, Sequelize) => {
    await queryInterface.sequelize.transaction(async (t) => {
      ...
      await queryInterface.addColumn('goals', 'status', {
      ...
      await queryInterface.removeColumn('goals', 'status_id', { transaction: t });
    });
  }
};
