      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-between gap-3">
            {/* Edit Team Button */}
            <button
              onClick={() => onEditTeam ? onEditTeam(team) : router.push(`/admin/edit-team/${team.id}`)}
              className={`flex-1 px-6 py-3 rounded-2xl border font-semibold text-sm transition-all duration-300
                flex items-center justify-center gap-2 hover:scale-105 hover:-translate-y-1
                ${isHovered 
                  ? `${teamTheme.bg.replace('bg-gradient-to-br', 'bg-gradient-to-r')} ${teamTheme.border} ${teamTheme.text} shadow-lg ${teamTheme.glow}` 
