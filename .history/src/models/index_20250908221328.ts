...
export const initializeModels = (sequelizeInstance: Sequelize = sequelize): void => {
  ...
  initProjectMessage(sequelizeInstance);
  initProjectMember(sequelizeInstance);
  initUserActivity(sequelizeInstance);
  initUserPreference(sequelizeInstance);
  initTeamMember(sequelizeInstance);
  initNotification(sequelizeInstance);
  initTaskAssignee(sequelizeInstance);
...
export const setupAssociations = () => {
  ...
  User.hasMany(TaskComment, { foreignKey: "user_id", as: "taskComments" });
   User.hasMany(ProjectMessage, { foreignKey: "sender_id", as: "messages" });
  // -------------------
