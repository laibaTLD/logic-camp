...
class Notification extends Model<NotificationAttributes, NotificationCreationAttributes> implements NotificationAttributes {
  ...
  public type!: 'project_created' | 'task_assigned' | 'chat_unread' | 'project_updated' | 'task_completed' | 'team_added';
  ...
  Notification.init(
    {
      ...
      type: {
        type: DataTypes.ENUM('project_created', 'task_assigned', 'chat_unread', 'project_updated', 'task_completed', 'team_added'),
        allowNull: false,
      },
      isRead: {
