...
// UserPreference and UserActivity are already initialized in their files
// but we need to ensure they're synced with the database
...
export const initializeModels = async (): Promise<void> => {
  ...
  // Sync UserPreference and UserActivity models (they are already initialized)
...
export const setupAssociations = () => {
  ...
  Project.hasMany(Goal, { foreignKey: "projectId", as: "goals" });
  ...
  // Goal associations
  // -------------------
  Goal.belongsTo(Project, { foreignKey: "projectId", as: "project" });
