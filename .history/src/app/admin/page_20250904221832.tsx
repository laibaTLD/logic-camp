      ...
      <Header>
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl border border-emerald-500/50 bg-gradient-to-r from-emerald-600 to-teal-600 px-6 py-3 text-sm font-medium text-white hover:from-emerald-500 hover:to-teal-500 transition-all duration-300 shadow-lg hover:shadow-xl"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
            </svg>
       ...
       <div className="flex min-h-screen">
         ...
         {/* Main Content */}
         <main className="flex-1 px-6 md:px-10 py-8 ml-64">
           {renderContent()}
         </main>
       </div>
