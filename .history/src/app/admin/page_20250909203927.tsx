                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                  ...
                  const memberList = Array.isArray(team.members)
                    ...
                    : Array.isArray(anyTeam.Users)
                      ? anyTeam.Users
                      : [];
                  const memberCount = typeof anyTeam.membersCount === 'number'
                    ? anyTeam.membersCount
                    : memberList.length;
                  return (
                    <div
                      key={team.id}
                    ...
                    >
                      ...
                      <button
                        onClick={() => setEditingTeam({ id: team.id, name: team.name, members: memberList })}
                   ...
                   <div className="flex flex-col sm:flex-row items-center justify-between pt-6 border-t border-slate-700/50 gap-4">
                     <div className="flex items-center gap-2 text-sm text-slate-400">
                       ...
                       <span className="font-semibold text-white">
                         {teams.length > 0 ? ((teamsPage - 1) * teamsPerPage) + 1 : 0}-{teams.length > 0 ? (teamsPage - 1) * teamsPerPage + teams.length : 0}
                       </span>
                       ...
                       <span className="text-xs text-slate-500 ml-2">
                         (Page: {teamsPage}, PerPage: {teamsPerPage}, TotalPages: {totalTeamsPages}, TeamsLength: {teams.length}, TotalTeams: {totalTeams})
                       </span>
                     </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
       <div className="flex min-h-screen">
         <AdminSidebar 
           ...
           onCreateProject={() => router.push('/admin/create-project')}
         />
