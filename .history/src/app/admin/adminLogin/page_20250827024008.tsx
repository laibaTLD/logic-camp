...
export default function AdminLogin() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0b0b10] flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="pointer-events-none absolute -top-32 -left-32 h-96 w-96 rounded-full blur-3xl opacity-30 bg-gradient-to-br from-indigo-600/60 to-purple-600/60 animate-float"></div>
      <div className="pointer-events-none absolute -bottom-40 -right-40 h-[28rem] w-[28rem] rounded-full blur-3xl opacity-20 bg-gradient-to-tr from-fuchsia-500/50 to-cyan-500/50 animate-float animation-delay-2000"></div>
