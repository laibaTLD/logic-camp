...
import Header from "./components/Header"; // use your real header
import { Plus } from "lucide-react";

export default function AdminDashboard() {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const { users, projects, openProject, loadingProjects } = useAdminData();
  ...
  return (
    <div className="relative min-h-screen bg-[#0b0b10] text-white overflow-hidden">
      ...
      {/* Header with New Project button passed as children */}
      <Header>
        <button
