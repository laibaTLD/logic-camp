  ...
  return (
    <div className="relative min-h-screen bg-[#0b0b10] text-white overflow-hidden">
      ...
      <main className=" px-6 md:px-10 py-8">
        {/* Navigation Tabs */}
        <div className="mb-8">
          <div className="flex items-center gap-4 p-1 bg-white/5 rounded-xl border border-white/10 backdrop-blur-xl w-fit">
            <button
        ...
        <div className="flex flex-col gap-8 animate-fadeInUp">
          {/* Users Panel */}
          <section id="users-section" className="flex-1 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl p-6 shadow-[0_10px_40px_rgba(0,0,0,0.35)]">
          ...
          <section id="teams-section" className="flex-1 rounded-2xl bg-gradient-to-br from-slate-900/90 to-slate-800/90 border border-slate-700/50 backdrop-blur-xl p-6 shadow-[0_20px_60px_rgba(0,0,0,0.4)] relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              {loadingTeams ? (
                ...
                <>
                  ...
                  {/* Pagination Controls - Always show if there are teams */}
                  {totalTeams > 0 && (
                    <div className="flex items-center justify-between pt-6 border-t border-slate-700/50">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {/* Next button - Always visible but disabled when appropriate */}
                        <button
                          onClick={() => fetchTeams(teamsPage + 1)}
                          disabled={teamsPage >= totalTeamsPages || totalTeamsPages <= 1}
                          className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border text-sm font-medium transition-all duration-200 ${
                            teamsPage >= totalTeamsPages || totalTeamsPages <= 1
                              ? 'border-slate-700/50 bg-slate-800/30 text-slate-500 cursor-not-allowed'
                              : 'border-slate-600/50 bg-slate-800/60 text-white hover:bg-slate-700/60 hover:border-slate-500/50 hover:shadow-lg'
                          }`}
                        >
          ...
          {/* Projects Panel */}
          <section id="projects-section" className="static flex-1 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl p-6 shadow-[0_10px_40px_rgba(0,0,0,0.35)]">
