        ...
        <div className="relative z-10">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0 flex-1">
              ...
              {task.description && (
                <p className={`mt-1 sm:mt-2 text-xs sm:text-sm line-clamp-2 break-words transition-colors duration-300
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="p-1.5 text-red-400 hover:text-red-300 transition-colors hover:bg-red-500/20 rounded-full hover:scale-105 hover:-translate-y-0.5"
                title="Delete task"
              >
          ...
          {task.deadline && (
            <div className="mt-3 flex items-center justify-end gap-2 text-xs sm:text-sm text-gray-400">
              <div className="p-0.5 sm:p-1 bg-amber-500/20 rounded-md sm:rounded-lg">
                <Calendar className={`h-3 w-3 sm:h-4 sm:w-4 transition-colors duration-300 ${isHovered ? 'text-amber-300' : 'text-amber-400'}`} />
              </div>
              <span className={`font-semibold text-xs transition-colors duration-300 ${isHovered ? 'text-amber-300' : 'text-amber-400'}`}>
