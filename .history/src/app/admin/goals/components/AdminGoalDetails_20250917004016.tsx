            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  disabled={loading}
                  className="px-4 py-2 bg-indigo-600/80 hover:bg-indigo-600 text-white rounded-xl border border-indigo-500/30 shadow-md shadow-indigo-500/10 transition-all hover:scale-105 hover:-translate-y-0.5 disabled:opacity-50 disabled:hover:scale-100 disabled:hover:translate-y-0"
                >
                  {loading ? 'Saving...' : 'Save Changes'}
                </button>
                <button
                  onClick={() => setEditingGoal(false)}
                  className="px-4 py-2 bg-slate-600/80 hover:bg-slate-600 text-white rounded-xl border border-slate-500/30 shadow-md shadow-slate-500/10 transition-all hover:scale-105 hover:-translate-y-0.5"
                >
                  Cancel
                </button>
              </div>
        ...
        {!editingGoal && (
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-indigo-600/80 hover:bg-indigo-600 text-white rounded-xl border border-indigo-500/30 shadow-md shadow-indigo-500/10 transition-all hover:scale-105 hover:-translate-y-0.5"
            >
            ...
            <button
              ...
              disabled={loading}
              className="flex items-center gap-2 px-4 py-2 bg-red-500/80 hover:bg-red-500 text-white rounded-xl border border-red-500/30 shadow-md shadow-red-500/10 transition-all hover:scale-105 hover:-translate-y-0.5 disabled:opacity-50 disabled:hover:scale-100 disabled:hover:translate-y-0"
            >
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-emerald-600/80 hover:bg-emerald-600 text-white rounded-xl border border-emerald-500/30 shadow-md shadow-emerald-500/10 transition-all hover:scale-105 hover:-translate-y-0.5"
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  disabled={loading}
                  className="px-4 py-2 bg-emerald-600/80 hover:bg-emerald-600 text-white rounded-xl border border-emerald-500/30 shadow-md shadow-emerald-500/10 transition-all hover:scale-105 hover:-translate-y-0.5 disabled:opacity-50 disabled:hover:scale-100 disabled:hover:translate-y-0"
                >
