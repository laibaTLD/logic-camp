...
export default function CreateProjectPage() {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      console.log('Teams data:', { teams, loadingTeams, teamsLength: teams?.length });
    }
  }, [teams, loadingTeams, isAuthenticated]);
  ...
  // Team members effect - moved after authentication checks
  useEffect(() => {
