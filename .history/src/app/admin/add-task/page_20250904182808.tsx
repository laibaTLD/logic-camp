        ...
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
          <div className="rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl p-8 shadow-[0_10px_40px_rgba(0,0,0,0.35)] space-y-8">
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                <div className="w-full px-4 sm:px-6 py-4 bg-gray-800/50 border border-white/10 rounded-2xl backdrop-blur-sm relative z-10 max-h-64 sm:max-h-80 lg:max-h-96 overflow-y-auto">
                  {/* Select All Option */}
