                   ...
                   <div className="flex flex-col sm:flex-row items-center justify-between pt-6 border-t border-slate-700/50 gap-4">
                     <div className="flex items-center gap-2 text-sm text-slate-400">
                       ...
                       <span className="font-semibold text-white">
                         {teams.length > 0 ? ((teamsPage - 1) * teamsPerPage) + 1 : 0}-{teams.length > 0 ? Math.min((teamsPage - 1) * teamsPerPage + teams.length, totalTeams) : 0}
                       </span>
                       ...
                       <span className="text-xs text-slate-500 ml-2">
                         (Page: {teamsPage}, PerPage: {teamsPerPage}, TotalPages: {totalTeamsPages})
                       </span>
                     </div>
