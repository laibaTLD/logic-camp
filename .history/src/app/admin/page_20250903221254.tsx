...
export default function AdminDashboard() {
  ...
  // Only initialize useAdminData after authentication is verified
  const adminDataHook = isAuthenticated ? useAdminData() : null;
  ...
  const {
    ...
    openProject = async () => {},
    createProject = async () => {},
    createTeam = async () => {}, // ✅ make sure this exists in your hook
  } = adminDataHook || {};
