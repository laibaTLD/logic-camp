            ...
            <div className="flex items-center gap-4 text-sm">
              {owner && (
                <div className="flex items-center gap-2">
                  ...
                  <span className={`transition-colors duration-300 ${isHovered ? 'text-gray-300' : 'text-gray-400'}`}>
                    {owner.name}
                  </span>
                </div>
              )}
              <div className={`flex items-center gap-2 transition-colors duration-300 ${isHovered ? 'text-gray-300' : 'text-gray-400'}`}>
