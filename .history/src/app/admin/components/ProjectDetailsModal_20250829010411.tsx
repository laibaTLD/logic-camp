...
export default function ProjectDetailsModal({
  ...
  return (
    <div className="absolute top-0 z-50 h-screen w-screen flex items-center justify-center bg-black/70 backdrop-blur-xl p-4 animate-fadeIn" onClick={onClose}>
      {/* Modal */}
      <div className="absolute top-0 bg-white w-5 h-5"></div>
      <div 
        className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-[0_12px_40px_rgba(0,0,0,0.35)] relative animate-scaleIn"
        ...
        <div className="p-6 pt-0 space-y-6">
          ...
          <div className="flex gap-3 pt-6 border-t border-white/10">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-600/20 hover:bg-blue-600/30 border border-blue-500/30 text-blue-300 hover:text-blue-200 transition-all duration-200 hover:scale-[1.02]"
              title="Edit Project"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-red-600/20 hover:bg-red-600/30 border border-red-500/30 text-red-300 hover:text-red-200 transition-all duration-200 hover:scale-[1.02]"
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-green-600/20 hover:bg-green-600/30 border border-green-500/30 text-green-300 hover:text-green-200 transition-all duration-200 hover:scale-[1.02]"
              title="Add Task"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
