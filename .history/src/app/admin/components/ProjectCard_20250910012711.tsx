  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Meta */}
        <div className="mt-5 grid grid-cols-3 gap-3 text-xs text-gray-400">
          {project.endDate && (
            <div className="flex items-center gap-2 min-w-0 bg-yellow-500/10 px-2.5 py-1.5 rounded-lg border border-yellow-500/20 group-hover:border-yellow-500/30 transition-all duration-300 col-span-2">
          ...
          <div className="flex items-center gap-2 min-w-0 bg-purple-500/10 px-2.5 py-1.5 rounded-lg border border-purple-500/20 group-hover:border-purple-500/30 transition-all duration-300 col-span-3">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3 text-xs">
          ...
          {/* Updated Date */}
          <div className="flex items-center gap-2 bg-slate-500/10 px-2.5 py-1.5 rounded-lg border border-slate-500/20 group-hover:border-slate-500/30 transition-all duration-300 justify-end">
        ...
        <div className="mt-5 flex justify-end">
          <button
            ...
            hover:shadow-md hover:shadow-red-500/10 transform hover:-translate-y-0.5 relative z-20"
          >
