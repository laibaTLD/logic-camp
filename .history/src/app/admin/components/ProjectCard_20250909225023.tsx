...
import { Users, Calendar, FolderKanban, Edit, Trash2, ChevronDown, ChevronUp, Plus, Target } from "lucide-react";
...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, index, onOpenProject, onEditTask, onDeleteTask, onAddTask, tasks = [], onLoadTasks }) => {
  ...
  // Removed task state management since tasks are now managed under goals
