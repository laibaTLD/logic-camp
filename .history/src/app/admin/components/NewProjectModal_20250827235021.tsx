...
export default function NewProjectModal({ isOpen, onClose, users, onProjectCreated }: NewProjectModalProps) {
    ...
    try {
      ...
      const res = await fetch("/api/admin/projects", {
        ...
        body: JSON.stringify({
          name,
          description,
          // For now, we send members as an array of user IDs
          teamId: selectedMembers[0] || null, // optional: assign first member as teamId
          members: selectedMembers, // backend can use this later if you implement ProjectMembers
        }),
      });
