        ...
        <div className="absolute top-4 right-4 z-10">
          {project.status && (
            <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full shadow-lg backdrop-blur-md
              ${project.status === 'completed' ? 'bg-green-500/20 border border-green-500/30' : 
                project.status === 'in-progress' ? 'bg-blue-500/20 border border-blue-500/30' : 
                project.status === 'review' ? 'bg-purple-500/20 border border-purple-500/30' : 
                'bg-gray-500/20 border border-gray-500/30'}
              hover:shadow-xl hover:scale-105 transition-all duration-300 group-hover:shadow-md
              ${project.status === 'completed' ? 'group-hover:shadow-green-500/30 group-hover:border-green-400/50' : 
                project.status === 'in-progress' ? 'group-hover:shadow-blue-500/30 group-hover:border-blue-400/50' : 
                project.status === 'review' ? 'group-hover:shadow-purple-500/30 group-hover:border-purple-400/50' : 
                'group-hover:shadow-gray-500/30 group-hover:border-gray-400/50'}
              transform-gpu`}>
