...
export default function ProjectDetailsModal({
  ...
  return (
    <div className="absolute top-0 z-50 h-screen w-screen hidden items-center justify-center bg-black/70 backdrop-blur-xl p-4 animate-fadeIn" onClick={onClose}>
      {/* Modal */}
      <div 
