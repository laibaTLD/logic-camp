...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, index, onOpenProject, onEditProject }) => {
              ...
              <div className={`flex items-center gap-3 p-4 rounded-2xl border transition-all duration-300
                ...
                <div>
                  ...
                  <p className={`font-bold text-sm transition-colors duration-300 ${isHovered ? 'text-indigo-300' : 'text-indigo-400'}`}>
                    {owner.name} <span className="text-xs text-gray-400">(ID: {project.ownerId})</span>
                  </p>
                </div>
              </div>
            )}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className={`flex items-center gap-3 px-4 py-3 rounded-2xl border transition-all duration-300
              ...
              <div className="p-2 bg-cyan-500/20 rounded-xl">
                <Calendar className={`h-5 w-5 transition-colors duration-300 ${isHovered ? 'text-cyan-300' : 'text-cyan-400'}`} />
              </div>
              <div>
                <p className="text-xs text-gray-400 uppercase tracking-wider">Last Updated</p>
                <p className={`font-semibold text-sm transition-colors duration-300 ${isHovered ? 'text-cyan-300' : 'text-cyan-400'}`}>
