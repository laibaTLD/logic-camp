...
export default function ProjectDetailsModal({
  ...
  return (
    <div className="absolute inset-0 z-50 h-screen w-screen flex items-center justify-center bg-black/70 backdrop-blur-xl p-4 animate-fadeIn" onClick={onClose}>
      {/* Modal */}
      <div 
