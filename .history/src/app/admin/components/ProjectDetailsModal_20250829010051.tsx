...
export default function ProjectDetailsModal({
  ...
  return (
    <div className="absolute top-0 z-50 h-screen w-screen flex items-center justify-center bg-black/70 backdrop-blur-xl p-4 animate-fadeIn" onClick={onClose}>
      {/* Modal */}
      <div 
        className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-[0_12px_40px_rgba(0,0,0,0.35)]  animate-scaleIn"
