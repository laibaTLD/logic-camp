...
export default function UserRow({
  ...
  return (
    <tr className="border-b border-white/10 hover:bg-white/5 transition-all duration-200 hover:shadow-sm">
      ...
      <td className="p-4 space-x-2 flex items-center">
        ...
        {user.isApproved ? (
          <button
            ...
            className="px-3 py-2 rounded-lg bg-yellow-600/20 hover:bg-yellow-600/40 border border-yellow-500/30 text-yellow-200 transition-all duration-200"
          ...
          <button
            ...
            className="px-3 py-2 rounded-lg bg-green-600/20 hover:bg-green-600/40 border border-green-500/30 text-green-200 transition-all duration-200"
            title="Approve User"
          >
            Approve
          </button>
        ...
        <button
          ...
          className="p-2 rounded-lg bg-indigo-600/20 hover:bg-indigo-600/40 border border-indigo-500/30 text-indigo-300 hover:text-indigo-200 transition-all duration-200 hover:scale-110 active:scale-95"
          title="Edit User"
        >
          <Pencil size={16} />
        </button>
        ...
        <button
          ...
          className="p-2 rounded-lg bg-red-600/20 hover:bg-red-600/40 border border-red-500/30 text-red-300 hover:text-red-200 transition-all duration-200 hover:scale-110 active:scale-95"
          title="Delete User"
        >
          <Trash2 size={16} />
        </button>
