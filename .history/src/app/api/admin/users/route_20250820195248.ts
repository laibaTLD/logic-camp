...
// 🆕 Import the shared admin middleware
...
// ----------------------
// Helper: verify admin (still used for PUT/DELETE)
// ----------------------
...
// ----------------------
// GET all users (✅ now using checkAdmin middleware)
// ----------------------
export async function GET(req: NextRequest) {
  // 🛡️ Protect with admin check
